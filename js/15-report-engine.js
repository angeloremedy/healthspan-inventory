...
const RPT_SOURCES = {
  ...
  orders:     { label: 'HQ orders', roles: ['admin','manager','sales','finance','supply_chain'], own: 'spec',
                cols: { num:'num', date:'date', account:'text', spec:'text', status:'text', total:'num', paid:'num', balance:'num', pay_status:'text', terms_days:'num', dr_no:'text', source:'text', fulfilled_at:'date', created_at:'date' } },
