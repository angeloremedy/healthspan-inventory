...
const SALES_VIEWS=['home','orgchart','ask','logvisit','followups','account','neworder','orders','order','spec','pickslip','pipeline','quotes','salesevents','complaints','pullouts','manual','crmstats','expreport','profile','bizreview','reports','savedreports','settings'].concat(['voucher','orderpay','proofpay','replenish','reimburse','cashadvance']);
...
function showView(v,el){
  ...
  const T={orgchart:'Org chart',bizreview:'Business review',reports:'Reports',savedreports:'Saved reports',qbo:'QuickBooks sync',ask:'Ask Healthspan',settings:'Settings',dashboard:'Dashboard',action:'Action center',customers:'Accounts (CRM)',health:'Data health',all:'All SKUs',oos:'Out of stock',low:'Low stock',neg:'Negative stock',
  ...
  else if(v==='orgchart') renderOrgChart();
